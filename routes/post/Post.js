...
export default new Router()
    .get('/', Middlewares.accessCheck, fetchPostsValidation,
        Middlewares.validationCheck, PostController.fetchAll)
    .get('/:id', Middlewares.accessCheck, PostController.fetchById)
    .post('/', Middlewares.accessCheck, postValidation,
        Middlewares.validationCheck, PostController.create)
